...
trait LoginUserServiceTrait
{
    ...
    public function createService(): LoginUserService
    {
        return $this->service = $this->app->make(LoginUserService::class, [
            'hash_manager' => $this->hash_manager_mock,
            'token_service' => $this->token_service_mock,
        ]);
    }
}
